...
CATEGORIES: list[tuple[str, tuple[str, ...]]] = [
    ...
    (
        "Squad cadence + markets",
        (
            "set_committee_cadence",
            "list_committee_markets",
            "add_committee_market",
            "remove_committee_market",
            "get_committee_readings",
            "set_committee_readings",
        ),
    ),
    (
        "Squad decisions",
        (
            "get_committee_decision_board",
            "list_committee_decisions",
            "get_committee_decision_summary",
        ),
    ),
